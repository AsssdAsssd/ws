...
bool center_msg_pkg__msg__singlecenter__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("center_msg_pkg.msg._singlecenter.Singlecenter", full_classname_dest, 45) == 0);
  }
  center_msg_pkg__msg__Singlecenter * ros_message = _ros_message;
  {  // center_x
...
{
  /* NOTE(esteve): Call constructor of Singlecenter */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("center_msg_pkg.msg._singlecenter");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Singlecenter");
